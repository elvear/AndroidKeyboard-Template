package com.klavye.shawnn.android;
...
public class LatinKeyboardView extends KeyboardView {
    ...
    protected boolean onLongPress(Key key) {
        ...
        if (key.codes[0] == Keyboard.KEYCODE_CANCEL) {
            ...
            return true;
        } else if (key.codes[0] == 'z' || key.codes[0] == 'Z' || key.codes[0] == '۶') {
            getOnKeyboardActionListener().onKey('ž', null);
            return true;

        } else if (key.codes[0] == 'z' || key.codes[0] == 'Z' || key.codes[0] == '۸') {
            getOnKeyboardActionListener().onKey(',', null);
            return true;

        } else if (((key.codes[0] == 'g' || key.codes[0] == 'G') && SoftKeyboard.mActiveKeyboard == "en_US") || key.codes[0] == '۴') {
            getOnKeyboardActionListener().onKey('ğ', null);
            return true;
